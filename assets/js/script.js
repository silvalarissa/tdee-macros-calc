...
function handleSubmit(event) {
  ...
  const gender = getInpuSelectValue('gender')
  const age = getInputNumberValue('age')
  const weight = getInputNumberValue('weight')
  const height = getInputNumberValue('height')
  const activityLevel = getInpuSelectValue('activity_level')
  tmb(gender, age, weight, height, activityLevel)
}

function getInpuSelectValue(id) {
...
function tmb(gender, age, weight, height, activityLevel) {
